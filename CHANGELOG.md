...
* Added mineralisation as a process that transfers mass from the dissolved pool to a mineralised CO2 pool. This is controlled by a separate `k_min` rate constant.
